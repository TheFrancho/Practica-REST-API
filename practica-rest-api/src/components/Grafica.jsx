...
const Grafica = () => {
	...
	// Variable y metodo para manejar el overlay de carga mientras se cargan los datos
	const [open, setOpen] = useState(true);
	const handleClose = () => {
		setOpen(false);
	};

	// Llamado cuando se entra a la vista para iniciar el
	// entrenamiento de la red neuronal correspondiente
	useEffect(() => {
